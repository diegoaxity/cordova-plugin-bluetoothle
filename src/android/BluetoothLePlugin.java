...
public class BluetoothLePlugin extends CordovaPlugin {
  ...
  private final String keyManufacturerId = "manufacturerId";
  private final String keyManufacturerData = "manufacturerData";
  ...
  */
  ...
  private synchronized void startScanAction(JSONArray args, CallbackContext callbackContext) {
    ...
    if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.LOLLIPOP) {
      ...
      int manufacturerData = obj.optString(keyManufacturerData, null);

      if (manufacturerData != "") {
          byte[] manufacturerDataBytes = Base64.decode("AAAAAAAAAAAAAAAAAA", Base64.NO_WRAP);
      }
